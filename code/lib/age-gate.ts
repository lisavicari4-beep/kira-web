...
/** Returns the cookie attribute object to be passed to NextResponse#cookies.set. */
...
/** Anything under these paths is gated. Sub-domain split is enforced separately. */
