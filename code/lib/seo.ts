...
export const defaultMetadata: Metadata = {
  ...
  title: {
    default: 'KIRA · read the universe',
    template: '%s · KIRA',
  },
  description:
    'KIRA — next-gen platform for manga, anime, comics & webcomics. AI-tuned discovery, immersive reader, motion comics, built-in viral video studio.',
