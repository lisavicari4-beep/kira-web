// ReadAlongOverlay — renders touch targets over JP text bounding boxes,
// pops a tooltip with kana + meaning + audio when tapped.
'use client';
...
function Tooltip({ tok, onClose }: { tok: JpToken; onClose: () => void }) {
  ...
  return (
    <div
      className="absolute pointer-events-auto bg-hot text-white p-2 rounded-lg shadow-hot text-left"
